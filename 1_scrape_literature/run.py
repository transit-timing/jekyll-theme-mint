...
def main():
    ...
    save_dir = f'/Users/kate/Desktop/arxiv/arxiv_dir/{planet_name}'

    if not os.path.isdir(save_dir): 
        os.mkdir(save_dir)


    if not os.path.isdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet_name}/'): 
        os.mkdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet_name}/')
    ...
    for filename in os.listdir(f'/Users/kate/Desktop/arxiv/arxiv_dir/{planet_name}'):
        ...
        if filename.endswith(".tar.gz"):
            ...
            try:
                ...
                tar = tarfile.open(f'/Users/kate/Desktop/arxiv/arxiv_dir/{planet_name}/' + filename, "r:gz")
                ...
                if not os.path.isdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet_name}/'): 
                    ...
                    if not os.path.isdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet_name}/{name}/'): 
                        os.mkdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet_name}/{name}/')


                tar.extractall(path=f'/Users/kate/Desktop/arxiv/untar_dir/{planet_name}/{name}/')
                tar.close()
            except:
