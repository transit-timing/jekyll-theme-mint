...
count = 0
total_count = 0
for arxiv_id in os.listdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet}'):
	tex_files = 0
	for filename in os.listdir(f'/Users/kate/Desktop/arxiv/untar_dir/{planet}/{arxiv_id}'):
		if filename.endswith(".tex"):
			#print('filename: ', filename)
			data = open(f'/Users/kate/Desktop/arxiv/untar_dir/{planet}/{arxiv_id}/' + filename, errors='ignore').read()
				...
				for i in range(len(numbers)):
					...
					if measurement > 2000000: #and (data.find("BJD") or data.find("HJD")) and (data.find("epoch") or data.find("mid-transit time") or data.find("transit time") or data.find("mid-point")):
						...
						try:
							...
							arxiv.download(paper, dirpath = f'/Users/kate/Desktop/arxiv/article_database/{planet}')
						except:
...
np.savetxt(f'/Users/kate/Desktop/arxiv/article_database/{planet}/arxiv_ids_w_mid_times.txt', np.array(IDs), fmt='%s')
