...
observables = pd.read_csv('/Users/kate/Documents/research/paper/3_tables/v0/3_tables/observables.csv')
...
for folder in os.listdir('/Users/kate/Documents/research/paper/6_database/planets_1/'):
    planet_name = folder.replace('-mid-times', '')
    print(planet_name)
    current_name = systems == planet_name.lower()
...
ephemerides.sort_values(["Target"], ascending=True).to_csv('/Users/kate/Documents/research/paper/3_tables/2_ephemerides/2_table_1_pt.csv')
