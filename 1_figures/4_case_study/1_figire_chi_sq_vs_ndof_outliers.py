...
# Figuring out outliers in the chi square vs ndof plot
#
...
#
# prints which targets have chi square > 1000 (chi square is calculated from both literature and tess data)
...
plt.savefig(f'/Users/kate/Documents/research/paper/2_figures/1_chi_square/chi_square_vs_ndof_outliers.png')
plt.show()
plt.close(fig)
