...
if True:
  ...
  #try:
    ...
    if np.sum(source == 'Our work') == 0:
        ...
        axs[0].plot(orbit_number_arr, ((t0 + P*orbit_number_arr + dpde_over_2 * orbit_number_arr**2)-linear_model)*24*60, 'black')
        axs[0].errorbar(orbit_number, o_c[m]*24*60, yerr = t_err[m]*24*60, fmt='o', mew = 1, mfc = '#069AF3', ecolor = '#069AF3', alpha = 0.6,  markersize = 9)
